...
export function Sidebar() {
  return (
    <>
      {/* ================= DESKTOP SIDEBAR ================= */}
      <aside className="fixed left-0 top-0 z-30 hidden h-screen lg:block lg:w-[280px] flex-none">
        <div className="relative h-full w-full overflow-hidden bg-white">
          <div className="relative flex h-full flex-col px-5 py-6">
            ...
            <motion.nav
              ...
              className="space-y-5 text-[0.7rem] uppercase tracking-[0.18em] text-slate-700 text-center"
            >
              {[
                ...
                <Link
                  key={item.label}
                  href={item.href}
                  className="group flex items-center justify-center gap-4 rounded-full px-3 py-2 transition-all hover:scale-[1.02]"
                >
            ...
            >
              <Link
                href="/pages/contact"
                className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#c12c28] px-4 py-2.5 text-[0.75rem] font-semibold text-white shadow-sm transition-all hover:bg-[#d73530] hover:shadow-md hover:scale-[1.02]"
              >
      ...
      <aside className="px-4 pt-6 pb-4 lg:hidden">
        <div className="relative flex flex-col rounded-3xl border border-slate-200 bg-white px-2 shadow-xl">
          ...
          {/* Navigation */}
          <nav className="flex justify-center flex-wrap gap-x-6 gap-y-3 text-[0.7rem] uppercase tracking-[0.16em] text-slate-600">
          ...
          <Link
            href="/pages/contact"
            className="mt-5 inline-flex items-center justify-center gap-2 rounded-xl border border-slate-300 bg-[#c12c28] px-4 py-2 text-[0.7rem] font-medium text-white shadow-md transition hover:bg-[#d73530]"
          >
            <span>Start a project</span>
            <span className="text-sm">↗</span>
          </Link>
