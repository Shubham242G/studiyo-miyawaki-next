...
const teamSlides = [
  ...
  },
  {
    ...
    bio: "Manan keeps launches smooth by preparing, structuring, and uploading content with care, so what goes live matches what was planned.",
      ...
      >
        <div className="min-h-screen pb-20 pt-4 lg:pb-16 lg:pt-10 lg:pr-10 px-4">
          <div className="space-y-10">
            ...
            {/* SERVICES (with CTA added to main left card) */}
            <MotionSection
              id="services"
              variants={staggerContainer}
              initial="hidden"
            ...
            >
              {/* LEFT – SERVICES INTRO (main card with background image + CTA) */}
              <MotionDiv
                variants={fadeInUp}
                className=" relative col-span-12 md:col-span-4 flex flex-col justify-between overflow-hidden rounded-3xl border border-slate-200 p-5 shadow-md "
              >
                {/* Background image */}
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('/assets/images/aboutUs.webp')",
                  }}
                />
                ...
                <div className="relative z-20">
                  ...
                  <p className="mt-3 text-[0.8rem] text-white/90">
                    We design and build digital systems that stay
                    relevant — strategically planned, carefully
                    engineered, and continuously improved over time.
                  </p>
                </div>

                {/* CTA added only on this main card */}
                <div className="relative z-20 mt-5">
                  <Link href="/pages/contact">
                    <motion.button
                      whileHover={{ y: -2, scale: 1.03 }}
                      whileTap={{ scale: 0.98 }}
                      className="inline-flex items-center gap-2 rounded-full bg-white/95 px-6 py-2 text-[0.75rem] font-semibold text-slate-900 shadow-md shadow-slate-900/30"
                    >
      ...
      <p className="mt-2 text-[0.75rem] leading-relaxed text-slate-700">
        Signature podcast systems for creators and professionals who want to build massive reach, drive deep engagement, and establish undeniable authority through professionally produced audio content that resonates, converts listeners into loyal fans, and positions you as the go-to voice in your niche.
            ...
            <MotionSection
              ...
              className=" relative mt-28 overflow-hidden rounded-3xl border border-slate-200 px-5 py-10 shadow-md md:px-10 "
            >
              {/* SECTION LABEL */}
              ...
              <div className="grid items-stretch gap-8 md:grid-cols-12">
                {/* LEFT — CARD (background + gradient matching service cards) */}
                <MotionDiv
                  variants={fadeInUp}
                  className=" col-span-12 md:col-span-4 h-full rounded-3xl border border-slate-200 bg-white px-6 py-6 shadow-md flex flex-col relative overflow-hidden"
                >
                  ...
                  <div className="mt-4 flex-1 min-h-[160px] relative z-10">
                  ...
                  {/* DOTS */}
                  <div className="mt-5 flex justify-center gap-1.5 relative z-10">
                    {aboutSlides.map((_, idx) => (
                      <button
                        key={idx}
                        onClick={() =>
                          setActiveAboutIndex(idx)
                        }
